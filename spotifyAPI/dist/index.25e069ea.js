...
})({"1YBo6":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 3001;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "e386d364d693527b32b4966f25e069ea";
// @flow
...
},{}],"4NgQD":[function(require,module,exports) {
// Variables
...
const key = "YzdhNzM0YmQ1ZDdkNGU0MDhmNWRjNjU4MTEyMTM4OWQ6N2VkMzkxZDNhOGZjNDcwYWEwNTM0YjIzZjljODAyZjg=";
const searchSong = async songName => {
  const song = songName.replace(" ", "%20").toLowerCase();
  let cards = `<div class="container">`;
  try {
    // get a token
...
const createCard = (songInfo, isRecommended) => {
  const image = songInfo["album"]["images"][1]["url"];
  const album = songInfo["album"]["name"];
  const name = songInfo["name"];
  const artist = songInfo["artists"][0]["name"];
  const songURL = songInfo["external_urls"]["spotify"];
  const message = isRecommended ? "Now, you should listen to" : "Your input song was";
  return `
    <div class="card">
        <h2>${message}</h2>
        <div class="image">
...
},{}]},["1YBo6","4NgQD"], "4NgQD", "parcelRequire9887")

//# sourceMappingURL=index.25e069ea.js.map
